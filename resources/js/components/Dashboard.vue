<template>
  <div>
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
      ...
      <button @click.prevent="logout" class="justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-red-600 bg-white hover:bg-red-50">
        Logout
      </button>
    </div>
